...
import com.tianya.bigdata.homework.day20200929.utils.{DateUtils, FileUtils, IpUtils}
...
object SparkSQLAccessLogApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession
      ...
      .master("local")
      .config("spark.sql.sources.commitProtocolClass", "com.tianya.bigdata.homework.day20200929.MyHadoopMapReduceCommitProtocol")
      .getOrCreate()
    ...
    val path = "F:\\study\\ruozedata\\review\\ruozeg9\\ruozedata-homework\\src\\main\\java\\com\\tianya\\bigdata\\homework\\day20200929\\data\\access2.txt"
...
//      .option("compression","bzip2")
    ...
    spark.conf.set("spark.sql.sources.commitProtocolClass","com.tianya.bigdata.homework.day20200929.MyHadoopMapReduceCommitProtocol2")

    val inputDF: DataFrame = spark.read.format("com.tianya.bigdata.homework.day20200929").load(outPut)

    inputDF.write.partitionBy("time","domain").option("timestampFormat", "yyyy/MM/dd HH:mm:ss ZZ").format("csv").save(outPut2)
